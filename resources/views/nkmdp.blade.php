                ...
                <tbody class="text-gray-700 text-sm">
                    @forelse($notaKesepahaman as $index => $nota)
                        <tr class="border-b hover:bg-gray-50">
                            ...
                            <td class="py-3 px-4">{{ $nota->jenis_dokumen }}</td>
                            <td class="py-3 px-4">{{ $nota->perihal_dokumen }}</td>
                            <td class="py-3 px-4">{{ $nota->satker_kemlu_terkait }}</td>
                            <td class="py-3 px-4">{{ $nota->kl_external_terkait }}</td>
                            <td class="py-3 px-4">{{ $nota->tanggal_disahkan->format('d-m-Y') }}</td>
                            <td class="py-3 px-4">{{ $nota->tanggal_berakhir->format('d-m-Y') }}</td>
