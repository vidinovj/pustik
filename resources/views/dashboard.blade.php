        ...
        <div class="bg-white rounded-lg shadow-lg p-6 mt-4">
            <div class="grid md:grid-cols-3 gap-4">
                <div class="bg-blue-50 p-4 rounded-lg">
                    ...
                    <a href="{{ route('kebijakan-internal') }}" class="mt-4 inline-block text-blue-600 hover:text-blue-800">Lihat detail →</a>
                </div>
                <div class="bg-green-50 p-4 rounded-lg">
                    ...
                    <a href="{{ route('kebijakan-eksternal') }}" class="mt-4 inline-block text-green-600 hover:text-green-800">Lihat detail →</a>
                </div>
                <div class="bg-purple-50 p-4 rounded-lg">
                    <h2 class="text-xl font-semibold text-purple-800 mb-2">Pusdatin</h2>
                    <p class="text-gray-600">Dokumen kerja sama dan nota kesepahaman dengan berbagai instansi.</p>
                    <a href="{{ route('pusdatin') }}" class="mt-4 inline-block text-purple-600 hover:text-purple-800">Lihat detail →</a>
                </div>
